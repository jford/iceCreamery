...
<html>
	<head>
		...
		<title>Ice Creamery: Salt Free Recipes</title>
...
<body>
	<div class="contentDisplayArea">
		...
		Salt Free Recipes
			...
			Vector<String> recipeNames = recipeMgr.getNamesRecsWithNoEnumType("salt");
			...
			{
			%>
				<p>There are no salt free recipes.</p>
			<%
			}
			else
			{
			...
			%>
				<p>
				The following <%= Integer.toString(recipeNames.size()) %> recipes do not specify any salt:
				</p>
				<ul>
			<%
			}
